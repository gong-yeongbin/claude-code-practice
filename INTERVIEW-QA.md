...
| id | po_id | seq | event_type | payload(델타) | created_at |
|---|---|---|---|---|---|
| 1 | 1 | 1 | CREATED | `{productName:"볼트", quantity:100, unitPrice:"1000.00", deliveryDate:"07-01", spec:{...}}` | 06-01 |
| 2 | 1 | 2 | UPDATED | `{quantity:{old:100, new:150}}` | 06-10 |
| 3 | 1 | 3 | UPDATED | `{unitPrice:{old:"1000.00", new:"1200.00"}}` | 06-15 |

→ 현재 수량이 얼마인지 들고 있는 행이 없음. seq 순서대로 접어야 알 수 있음.
...
| 방식 | 처리 방법 |
|---|---|
| A 델타 | seq=1,2 행 읽고 코드에서 재적용(seq=3은 06-15라 제외) → 결과 조립 |
